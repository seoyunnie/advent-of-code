...
2. Download the puzzle input files from [adventofcode.com](https://adventofcode.com/) and place them in the
   [`inputs`](./inputs/) folder. The file names should follow the format `day_(0[1-9]|1[0-9]|2[0-5])\.txt` (e.g.
   `day_01.txt`.).
